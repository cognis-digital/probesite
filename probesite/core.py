"""PROBESITE core — Synthetic uptime and Playwright checks exported to Prometheus."""
...
RULES = [
    ("PRO-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("PRO-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("PRO-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
