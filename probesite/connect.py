"""Native cognis-connect emit for probesite — forward findings to any platform.

Maps probesite's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    probesite ... --format json | probesite-emit --to stix
    probesite-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
