#!/usr/bin/env sh
# Universal installer for probesite. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/probesite.git"
echo "Installing probesite ..."
